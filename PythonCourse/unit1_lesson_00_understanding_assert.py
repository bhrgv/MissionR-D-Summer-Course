...
def test_make_assert_true_2():
    assert 2**36 > 2**30, "Fill in value greater than 2**30"
...
Assert is a check for testing cases in the program
syntax of function definations, comments , Multi-line comments
