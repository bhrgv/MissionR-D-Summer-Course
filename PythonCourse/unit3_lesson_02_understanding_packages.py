...
def test_package_import_failure():
    ...
    why_it_failed = "it dosnt contain file __init__.py"
...
-__init__ is executed before the Import of Package
-Visiblity of Package and Modules in sys.modules and Locals
-importing all files in a subpackage changing __init__.py
"""
