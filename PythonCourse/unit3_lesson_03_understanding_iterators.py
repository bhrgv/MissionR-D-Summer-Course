...
def test_find_builtins_that_work_on_iterables():
    funcs = ['all','any','dict','filter','frozenset','list','map','max','min','next','reduce','set','sorted','sum','tuple','zip']
    assert 16 == len(funcs)
...
-difference between list and iterable
-formation of list and tuples
-functions taking iterable
"""